...
- [Oman Server App](oman-serverp-app.md)

- [Input Oman APP TDD](input-oman-app-tdd.md)
- [Output Oman app](output-oman-app.md)
- [Output SW Architect General](ouput-sw-architect-general)
- [Output SW Architect Microfrontends](output-sw-architect-microfrontends.md)
